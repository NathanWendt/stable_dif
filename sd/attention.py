...
class SelfAttention(nn.Module):
    ...
    def forward(self, x: torch.Tensor, causal_mask=False):
        ...
        # (Batch_size, Seq_len, Dim) -> (Batch_size, Seq_le, H, Dim/H) -> (Batch_Size, H, Seq_len, Dim/H)
        ...
        # (Batch_size, Seq_len, Seq_len) @ (Batch_size, H, Seq_len, Dim / H) -> (Batch_size, H, Seq_len, Dim / H)
        output = weight @ v
